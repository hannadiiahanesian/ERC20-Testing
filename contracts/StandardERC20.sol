...
contract StandardERC20 is IERC20 {
    ...
    function increaseAllowance(address spender, uint256 addValue)
        public
        returns (bool)
    {
        _approve(
            msg.sender,
            spender,
            _allowances[msg.sender][spender] + addValue
        );
        return true;
    }
    ...
    function decreaseAllowance(address spender, uint256 addValue)
        public
        returns (bool)
    {
        _approve(
